...
type Post struct {
	...
	UserReaction string    `json:"userReaction,omitempty" gorm:"-"` // The current user's reaction, if any
...
func (p *Post) ToDTO(user UserDTO) PostDTO {
	return PostDTO{
		...
		Comments:     make([]CommentDTO, 0), // Comments will be populated separately
