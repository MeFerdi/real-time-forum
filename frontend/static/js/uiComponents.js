    ...
    renderHome(categories = []) {
        return `
            <div class="min-h-screen flex">
                <!-- Category Sidebar -->
                <aside id="category-sidebar" class="w-64 bg-gray-900 p-4 hidden md:block">
    ...
    renderPost(post) {
        return `
            <div data-post-id="${post.id}" class="post-card">
                ...
                ` : ''}
                <div class="post-actions flex gap-3 mt-2">
                    <button class="reaction-btn like-btn ${post.user_reaction === 'like' ? 'text-blue-600' : 'text-gray-400'}" data-post-id="${post.id}">
                        <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05 A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z" />
                        </svg>
                        <span class="like-count">${post.like_count || 0}</span>
                    </button>
                    <button class="reaction-btn dislike-btn ${post.user_reaction === 'dislike' ? 'text-red-600' : 'text-gray-400'}" data-post-id="${post.id}">
                        <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
